...
Model='gcn'#graphsage_mean,gcn, graphsage_seq,graphsage_maxpool,graphsage_meanpool
kw,deg_threshold='combined_score',0.05  #'similarity', 'experimental', 'database', 'textmining', 'combined_score'
LOSS='focal' # sigmoid, softmax, focal
focal_alpha=0.75
...
train_data = load_data('example_data/example_data')
