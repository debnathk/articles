#!/bin/bash
#SBATCH --job-name=evaluate_deepPurpose_bin
#SBATCH --output evaluate_deepPurpose_dti_cnn_cnn_davis_50epoch_bin.log
#SBATCH --error error_evaluate_deepPurpose_dti_cnn_cnn_davis_bin.log
...
python evaluate_deepPurpose_dti_cnn_cnn_davis.py
